  ...
  render() {
    return (
      ...
      />
        ...
        <Switch>
          <Route exact path="/about"> <News setProgress={this.setProgress} key="science"Size={5} country= "in" category='science'/> </Route>
          ...
          <Route exact path="/entertainment"> <News setProgress={this.setProgress} key="" pageSize={this.pageSize} country= "in" category='entertainment'/> </Route>
          ...
          <Route exact path="/sports"> <News setProgress={this.setProgress} key="sports"pageeSize={5} country= "in" category='sports'/> </Route>
